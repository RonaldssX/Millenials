...
class AlertView: UIView, NotificationViewProtocol {
    ...
    fileprivate var button1: UIButton? {
        ...
        didSet {
            ...
            self.button1?.leadingAnchor.constraint(equalTo: buttonsView.leadingAnchor).isActive = true
            
            self.button1?.topAnchor.constraint(equalTo: buttonsView.topAnchor).isActive = true
            self.button1?.bottomAnchor.constraint(equalTo: buttonsView.bottomAnchor).isActive = true
    ...
    fileprivate var button2: UIButton? {
        ...
        didSet {
            ...
            self.button2?.trailingAnchor.constraint(equalTo: buttonsView.trailingAnchor).isActive = true
            
            self.button2?.topAnchor.constraint(equalTo: buttonsView.topAnchor).isActive = true
            self.button2?.bottomAnchor.constraint(equalTo: buttonsView.bottomAnchor).isActive = true
    ...
    public func configure() {
        ...
        if (buttons.count == 2) {
            ...
            button1?.trailingAnchor.constraint(equalTo: buttonsView.centerXAnchor).isActive = true
            
            button2?.widthAnchor.constraint(equalTo: button1!.widthAnchor).isActive = true
            button2?.leadingAnchor.constraint(equalTo: button1!.trailingAnchor, constant: -2).isActive = true
            
        } else {
            
            button1?.trailingAnchor.constraint(equalTo: buttonsView.trailingAnchor).isActive = true
        ...
        buttons.forEach({ button in
            ...
            if (buttons.count == 2) {
                ...
                button.titleLabel?.font = UIFont.defaultFont(size: 20, weight: .medium)
                
            } else {
            
                button.titleLabel?.font = UIFont.defaultFont(size: 25, weight: .medium)
