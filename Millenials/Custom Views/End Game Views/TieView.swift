...
class TieView: UIView {
    ...
    var player1ImageView: UIImageView! {
        ...
        didSet {
            ...
            self.player1ImageView.topAnchor.constraint(equalTo: playersBackgroundView.topAnchor, constant: (isiPad ? 115 : 25)).isActive = true
    ...
    var player1NameLabel: UILabel! {
        ...
        didSet {
            ...
            self.player1NameLabel.font = UIFont.defaultFont(size: (isiPad ? 22 : 15), weight: .semiBold)
            ...
            self.player1NameLabel.topAnchor.constraint(equalTo: player1ImageView.bottomAnchor, constant: (isiPad ? 30 : 15)).isActive = true
    ...
    var player2ImageView: UIImageView! {
        ...
        didSet {
            ...
            self.player2ImageView.topAnchor.constraint(equalTo: playersBackgroundView.topAnchor, constant: (isiPad ? 115 : 25)).isActive = true
    ...
    var player2NameLabel: UILabel! {
        ...
        didSet {
            ...
            self.player2NameLabel.font = UIFont.defaultFont(size: (isiPad ? 22 : 15), weight: .semiBold)
            ...
            self.player2NameLabel.topAnchor.constraint(equalTo: player2ImageView.bottomAnchor, constant: (isiPad ? 30 : 15)).isActive = true
    ...
    public func configure() {
        ...
        self.player1ImageView = UIImageView()
            ...
            player1ImageView.layer.borderColor = UIColor.LightPurple.cgColor
        ...
        self.player2ImageView = UIImageView()
            ...
            player2ImageView.layer.borderColor = UIColor.LightPurple.cgColor
