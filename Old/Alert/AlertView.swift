...
class AlertView: UIView {
    ...
    public weak var rootViewController: UIViewController! {
        ...
        didSet {
            ...
            if #available(iOS 10.0, *) {
                ...
                motionBlur = UIVisualEffectView(effect: UIBlurEffect(style: .dark))
    ...
    internal var alertWarningLabel: UILabel? {
        ...
        didSet {
            ...
            self.alertWarningLabel?.textColor = .OffWhite
    ...
    internal var alertMessageLabel: UILabel? {
        ...
        didSet {
            ...
            self.alertMessageLabel?.textColor = .OffWhite
    ...
    public var alertButtons: [AlertButton]? {
        ...
        didSet {
            ...
            _ = self.alertButtons!.map({(button) -> AlertButton in
