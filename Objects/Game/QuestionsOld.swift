...
fileprivate struct QuestionData {
    ...
    struct Phrases {
        ...
        var hardPhrases: [String] {
            ...
            return hard.lula + hard.mao + hard.bolsonaro + hard.temer
       ...
       private struct Medium {
            ...
            let bolsonaro = ["Eu fui num quilombola(...). O afrodescendente mais leve lá pesava sete arrobas. Não fazem nada. Eu acho que nem pra procriadores servem mais"]
       ...
       private struct Hard {
            ...
            let bolsonaro = ["Só não te estupro porque você não merece"]
        
            let temer = ["Ninguém mais é capaz de indicar os desajustes de preços no supermercado do que a mulher"]
