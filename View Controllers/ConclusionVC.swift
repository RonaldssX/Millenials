...
class ConclusionVC: UIViewController {
    ...
    private var winnerView: WinnerView? {
        ...
        didSet {
            ...
            self.winnerView?.configure()
                
            } else {
                
                self.winnerView?.configure(with: displayPlayer)
    ...
    private var animateTieLabel: UILabel? {
        ...
        didSet {
            ...
            self.animateTieLabel?.text = "Empate!"
            self.animateTieLabel?.backgroundColor = .clear
            self.animateTieLabel?.textColor = .OffWhite
            self.animateTieLabel?.font = UIFont.defaultFont(size: 20, weight: .bold)
    ...
    public var endGameButton: UIButton! {
        ...
        didSet {
            ...
            self.endGameButton.titleLabel?.font = UIFont.defaultFont(size: 20, weight: .regular)
    ...
    public var shouldConfigureDefault: Bool = true
    ...
    private func configureView() {
        ...
        if (Millenials.shared.endGameResults!.winningPlayer != nil) {
    ...
    private func returnToIntroVC() {       
        ...
        let navBar = navigationController as! NavigationVC
        
        navBar.returnToMainScreen()
    ...
    private func animateTie() {
            ...
            UIView.animate(withDuration: 0.6, delay: 0, options: [.preferredFramesPerSecond60, .curveEaseInOut], animations: {
                ...
                UILabel.animate(withDuration: 0.6, delay: 0.3, options: [.preferredFramesPerSecond60, .curveEaseInOut], animations: {
                    ...
                    self.navigationItem.title = "Empate!"
...
extension ConclusionVC {
    ...
    private func tieConfig() {
        ...
        endGameButton.setTitle("Finalizar", for: .normal)
